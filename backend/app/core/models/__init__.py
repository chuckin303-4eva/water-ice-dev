...
reviews, validation_queue, update_log, opportunities, competitors,
resource_listings, tasks, settings, and refresh_runs are designed in
docs/DATABASE.md but intentionally not modeled yet -- they arrive with
the migration for the phase that actually needs them.
"""
